import ContactForm from "@/components/forms/SimpleForm";
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className=" lg:col-span-1 bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-hidden">
          <div className="px-6 py-8 md:px-10">
            <h2 className="text-3xl font-semibold text-gray-900 dark:text-white mb-6">Contact Information Simple</h2>
            <div className="space-y-4">
              <div>
                <h3 className="text-lg font-medium text-gray-700 dark:text-gray-300">Address</h3>
                <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">123 Main Street, City, Country Simple</p>
              </div>
              <div>
                <h3 className="text-lg font-medium text-gray-700 dark:text-gray-300">Phone</h3>
                <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">+123 456 7890 Simple</p>
              </div>
              <div>
                <h3 className="text-lg font-medium text-gray-700 dark:text-gray-300">Email</h3>
                <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">info@example.com Simple</p>
              </div>
            </div>
          </div>
        </div>
